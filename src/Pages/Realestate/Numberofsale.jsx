...
const Numberofsale = (props) => {
  ...
  const calculateData = () => {
    ...
    const gettingData1 = applyTwoZeroes(jsonData.map((e) => e["Auckland Central"]));
    ...
    const gettingData5 = applyTwoZeroes(jsonData.map((e) => e["Wellington Central"]));


console.log('oafopfioif',gettingData1);
    ...
    tooltip: {
      ...
      formatter: function (params) {
        ...
        params.forEach(param => {
          ...
          // Check if the value is a number and apply two decimal places
          if (!isNaN(value)) {
